 	...
 	var node = groups
 		...
 		.on("mouseover", function(selected) {
    		...
    		d3.select(this.parentNode).append("foreignObject")
    			...
    			.html(function(d,i) {
    				return "<img src="+d.imgURL+" style='width:48px;height:48px;float:right;padding-bottom:5px'> "+"<bold>Name:</bold> " + d.name +"<br><bold>Description:</bold> Lorem ipsum I likie in the bumbum"
    				   			});
